...
int main() {
    ...
    printf("First write Stepper ID (0-%i) and then command: Setup (s), Set Time (t), Run (r), Halt "
           "(while in run) (h)\n",
    ...
    while (true) {
        ...
        default:
            ...
            printf("First write Stepper ID (0-%i) and then command: Setup (s), Set Time (t), Run "
                   "(r) [ID not relevant], Halt (while in run) (h)\n",
                   NUMBER_OF_DISPENSERS - 1);
        }
        printf("\n");
    }
